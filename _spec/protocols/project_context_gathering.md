...
2.  **Questioning Phase:**
    - Ask questions sequentially (one by one).
        ...
        - **Question 1.1 (Alias):** "Would you like to assign a short alias for this project? (e.g., `dc2` for `dev-console2`). If left blank, I will suggest one or proceed without it."
        - **Question 2 (Path):**
     "What is the filesystem path for this project? (Provide relative path from root, or leave blank to create a new one in `projects/`)"
