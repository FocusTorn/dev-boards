...
- [ ] Task: _spec - User Manual Verification 'Phase 1' (Protocol in workflow.md)
...
- [ ] Task: _spec - User Manual Verification 'Phase 2' (Protocol in workflow.md)
...
- [ ] Task: _spec - User Manual Verification 'Phase 3' (Protocol in workflow.md)
...
- [ ] Task: _spec - User Manual Verification 'Phase 4' (Protocol in workflow.md)
...
- [ ] Task: _spec - User Manual Verification 'Phase 5' (Protocol in workflow.md)
