...
def sync_tracks():
    ...
    src_commands_dir = os.path.join(workspace_root, 'conductor', 'commands', 'conductor')
    # Destination: The CLI command directory
    dest_commands_dir = os.path.join(workspace_root, '.gemini', 'commands', 'conductor')
    ...
    if not os.path.exists(src_commands_dir):
        ...
        src_commands_dir = os.path.join(workspace_root, 'conductor', 'commands')
        if not os.path.exists(src_commands_dir):
    ...
    print("Conductor commands have been synchronized and cleaned.")
