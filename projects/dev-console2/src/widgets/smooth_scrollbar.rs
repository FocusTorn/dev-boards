...
mod tests {
    ...
    fn test_scrollbar_interaction() {
        ...
        let lengths_large = ScrollLengths {
            content_len: 100,
            viewport_len: 10,
        };
...
impl ScrollBar {
    ...
    pub fn handle_event(
        ...
        let max_offset = (self
            .lengths
            .content_len
            .saturating_sub(self.lengths.viewport_len)) as f64;

        // Proportional thumb height
        let thumb_height =
            (self.lengths.viewport_len as f64 / self.lengths.content_len as f64 * height).max(1.0);
        ...
        match mouse_event.kind {
            MouseEventKind::Down(MouseButton::Left) => {
                ...
                if area.contains(mouse_pos) {
                    ...
                    if relative_y >= current_thumb_top
                        && relative_y <= current_thumb_top + thumb_height
                    {
                        //>
            ...
            MouseEventKind::Drag(MouseButton::Left) => {
                ...
                if interaction.is_dragging && travel_dist > 0.0 {
                    ...
                    let relative_y = (mouse_pos.y.saturating_sub(area.y)) as f64;
                    let new_top =
                        (relative_y - interaction.thumb_grab_offset_rows).clamp(0.0, travel_dist);
            ...
            MouseEventKind::ScrollDown => {
                ...
                let max_offset = self
                    .lengths
                    .content_len
                    .saturating_sub(self.lengths.viewport_len);
