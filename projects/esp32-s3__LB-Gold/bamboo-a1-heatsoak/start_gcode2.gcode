...
;= AVOID END STOP =================================================================================== 
G91                ; use incremental (or relative) positioning
...
M109 S25 H140 ; Wait for nozzle temp
...
M104 S{nozzle_temperature_initial_layer[initial_extruder]} ; No wait nozzle temp
...
G92 E0
G1 E5 F200
M104 S{nozzle_temperature_initial_layer[initial_no_support_extruder]} ; No wait nozzle temp
G92 E0
G1 E-0.5 F300
...
M104 S170 ; prepare to wipe nozzle  ; No wait nozzle temp
...
M104 S170 ; No wait nozzle temp to heatbed acceptable
...
M104 S140 ; prepare to abl ; No wait nozzle temp
G0 Z5 F20000
...
M104 S{nozzle_temperature_initial_layer[initial_extruder]} ; prepare to print ; No wait nozzle temp
...
M400
    ...
    M109 S{nozzle_temperature_initial_layer[initial_extruder]} ; Wait for nozzle temp
