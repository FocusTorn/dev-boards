...
M620 S[initial_no_support_extruder]A ; Start material switch sequence if using AMS
    ...
    M109 S{nozzle_temperature_initial_layer[initial_no_support_extruder]} ; Wait for nozzle to reach target print temp
...
G0 X128 E8 F{filament_max_volumetric_speed[initial_extruder]/(24/20)*60} ; Initial prime move
G0 X133 E.3742 F{filament_max_volumetric_speed[initial_extruder]/(0.3*0.5)/4*60} ; Slow segment
G0 X138 E.3742 F{filament_max_volumetric_speed[initial_extruder]/(0.3*0.5)*60} ; Fast segment
G0 X143 E.3742 F{filament_max_volumetric_speed[initial_extruder]/(0.3*0.5)/4*60} ; Slow segment
G0 X148 E.3742 F{filament_max_volumetric_speed[initial_extruder]/(0.3*0.5)*60} ; Fast segment
G0 X153 E.3742 F{filament_max_volumetric_speed[initial_extruder]/(0.3*0.5)/4*60} ; Slow segment
