...
trigger: always_on
---
# Extensionless File Handling Rules

## **CRITICAL EXECUTION DIRECTIVE**

**AI Agent Directive**: Follow extensionless file handling rules exactly for all relevant file tasks.
...
3. **Language-Specific Rules**: Apply all rules from `.agent/rules/by-language/[detected-language]/` as if the file had the correct extension
...
- Apply all `.agent/rules/by-language/python/*.mdc` rules
...
- Apply all `.agent/rules/by-language/javascript/*.mdc` or `.agent/rules/by-language/typescript/*.mdc` rules
...
1. **Language-Specific Rules**: Apply all rules from `.agent/rules/by-language/[language]/`
...
**Applied Rules**:
- `.agent/rules/by-language/python/code-organization.mdc`
- `.agent/rules/by-language/python/code-structure.mdc`
- `.agent/rules/formatting/terminal-output.mdc` (if applicable)
- `.agent/rules/tool/uv/workspace.mdc` (if using UV)
